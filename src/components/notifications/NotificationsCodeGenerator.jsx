...
export const generateCodeExample = (selectedComponent, language = 'js') => {
  ...
  switch (componentId) {
    case 'alert':
      if (isTypeScript) {
        return `// Complete Alert Component (TypeScript) - Copy & Paste Ready
...
export default AlertExample;`;
    ...
    case 'toast':
      if (isTypeScript) {
        return `// Complete Toast Component (TypeScript) - Copy & Paste Ready
...
export default ToastExample;`;
    ...
    case 'modal':
      if (isTypeScript) {
        return `// Complete Modal Component (TypeScript) - Copy & Paste Ready
...
export default ModalExample;`;
    ...
    case 'popover':
      if (isTypeScript) {
        return `// Complete Popover Component (TypeScript) - Copy & Paste Ready
...
export default PopoverExample;`;
    ...
    case 'tooltip':
      if (isTypeScript) {
        return `// Complete Tooltip Component (TypeScript) - Copy & Paste Ready
import { useState, useRef, useEffect, ReactNode } from 'react';
...
export default TooltipExample;`;
    ...
    case 'loading':
      if (isTypeScript) {
        return `// Complete Loading Component (TypeScript) - Copy & Paste Ready
import { useState, useEffect } from 'react';
...
export default LoadingExample;`;
    ...
    case 'progress':
      if (isTypeScript) {
        return `// Complete Progress Component (TypeScript) - Copy & Paste Ready
import { useState, useEffect } from 'react';
