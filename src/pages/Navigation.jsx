...
import { generateNavigationCodeExample } from '../components/navigation/NavigationCodeGenerator';

const NavigationCard = ({ component }) => {
                ...
                <button
                  onClick={() => {
                    navigator.clipboard.writeText(
                      generateNavigationCodeExample(component, codeLanguage)
                    );
                    setCopied(true);
        ...
        <div className="space-y-8">
          {navigationType
            ? (() => {
                ...
                return <NavigationCard component={component} />;
              })()
            : navigationComponentsData.map((component) => (
                <NavigationCard key={component.id} component={component} />
              ))}
        </div>
      </div>
    </div>
