...
import { inputComponents } from '../components/inputs/inputComponentsData';
import InputElementRenderer from '../components/inputs/InputElementRenderer';
import { generateCodeExample } from '../components/inputs/CodeGenerator';
...
const Inputs = () => {
  ...
  useEffect(() => {
    ...
    if (hash) {
      const component = inputComponents.find((comp) => comp.id === hash);
      if (component) {
        setSelectedComponent(component);
      }
    } else {
      setSelectedComponent(inputComponents[0]);
    }
  }, [location.hash]);
                      ...
                      {selectedComponent.id === 'checkbox' ? (
                        <div className="space-y-2">
                          <div className="text-sm text-gray-600 dark:text-blue-300">
                            ...
                            <div className="flex items-center justify-between py-1">
                              ...
                              <span className={`px-2 py-1 rounded text-xs font-medium ${
                                ...
                                {formData.newsletter ? '✓ Checked' : '☐ Unchecked'}
                              </span>
                            </div>
                            <div className="flex items-center justify-between py-1">
                              ...
                              <span className={`px-2 py-1 rounded text-xs font-medium ${
                                ...
                                {formData.marketing ? '✓ Checked' : '☐ Unchecked'}
                              </span>
                            </div>
                          </div>
                          <details className="mt-2">
                            ...
                            <pre className="text-xs text-gray-800 dark:text-gray-200 font-mono bg-gray-900 dark:bg-slate-900 p-2 rounded-lg border border-gray-700 dark:border-slate-600 overflow-x-auto mt-2">
