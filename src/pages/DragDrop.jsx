...
import { dragdropComponents, DragDropElementRenderer, generateDragDropCode } from '../components/dragdrop';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-6">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <span className={`px-3 py-1 text-sm font-medium rounded-full flex-shrink-0 ml-4 ${getComplexityColor(selectedComponent.complexity)}`}>
          ...
          <div className="mb-4">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
              {selectedComponent.features.map((feature, index) => (
                <div key={index} className="flex items-center space-x-2 text-sm text-gray-600 dark:text-blue-200">
                    ...
                    <button
                      onClick={() => {
                        navigator.clipboard.writeText(
                          generateDragDropCode(selectedComponent, codeLanguage)
                        );
                        setCopied(true);
